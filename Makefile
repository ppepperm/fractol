...
NAME= fractol
SRC := speed_by_billy_idol.c mandelbrot.c mandel_speed.c ship.c ship_speed.c spider1.c spider1_speed.c julia.c complex.c free.c main.c shortcut1.c shortcut2.c
